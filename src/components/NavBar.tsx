  ...
  return (
    <header className={style.navigation}>
      ...
      <nav ref={navRef} className={style.navLinks}> 
          ...
          <Link href={'/#blogs'} onClick={showNavBar}>Blog</Link>
          <Link href={'/#contact'} onClick={showNavBar}>Contact</Link>
          <button className={`${style.navBtn} ${style.navCloseBtn}`} onClick={showNavBar}>
            <FaTimes/>
          </button>
      </nav>
